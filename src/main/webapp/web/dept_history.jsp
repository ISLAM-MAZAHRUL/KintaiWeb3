...
<body>
    <div class="container">
        <div class="header">
            <h1>部署削除履歴一覧</h1>
            <a href="<%= request.getContextPath() %>/deptManage" class="btn btn-secondary">メニューへ戻る</a>
        </div>
                ...
                <tbody>
                    <% for (DeptBean deletedDept : deletedDeptList) { %>
                        <tr>
                            ...
                            <td><%= deletedDept.getDeletedAt() != null ? sdf.format(deletedDept.getDeletedAt()) : "-" %></td>
                            <td><%= deletedDept.getDeletedBy() != null ? deletedDept.getDeletedBy() : "-" %></td>
                            <td>
